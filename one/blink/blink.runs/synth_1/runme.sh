...
HD_PWD='/home/op/fpga/one/blink/blink.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinktop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinktop.tcl
