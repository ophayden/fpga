...
HD_PWD='/home/op/fpga/one/blink/blink.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinktop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinktop.tcl -notrace
